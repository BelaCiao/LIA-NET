...
const AboutPage: React.FC<AboutPageProps> = ({ navigateTo }) => {
  return (
    <div className="bg-transparent text-gray-300">
        ...
        {/* Introduction */}
        <section className="py-16 sm:py-20" data-animate-on-scroll>
            <div className="max-w-screen-xl mx-auto px-4 grid md:grid-cols-5 gap-12 items-center">
                <div className="md:col-span-2">
                    <div className="bg-primary-card/80 backdrop-blur-sm aspect-square rounded-lg flex items-center justify-center border border-white/10">
